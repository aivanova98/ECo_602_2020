...
# I can print out the contents by typing the name of the data frame

dat_1

# How to subset a data frame if i know the name of the column i'm interested in I can use the $ symbol
